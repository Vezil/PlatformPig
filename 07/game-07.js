...
Game.Collider = function() {
    ...
    this.collide = function(value, object, tile_x, tile_y, tile_size) {
        ...
        switch(value) {
            ...
            case 3: if(this.collidePlatformTop(object,tile_y)) return; // jezeli kolizja nie musimy sprawdzac nic wiecej
            ...
            case 15: if(this.collidePlatformTop(object,tile_y)) return;
                      if(this.collidePlatformLeft(object,tile_x+tile_size)) return;
                      if(this.collidePlatformRight(object,tile_x+tile_size)) return;
                     this.collidePlatformBottom(object,tile_y+tile_size); break;
        }
...
Game.Collider.prototype = {
    ...
    collidePlatformLeft:function(object, tile_left) {
        ...
        if(object.getRight() > tile_left && object.getOldRight()<=tile_left) {
            object.setRight(tile_left-0.01); // -0.01 dlatego zeby naprawic maly problem z zaokraglaniem
            object.velocity_x=0;
            return true;
    ...
    collidePlatformTop:function(object,tile_top) {
        ...
        if(object.getBottom() > tile_top && object.getOldBottom()<=tile_top) {
            ...
            object.setBottom(tile_top-0.01); // -0.01 dlatego zeby naprawic maly problem z zaokraglaniem
            object.velocity_y=0;
...
Game.Object.prototype = {
    ...
    collideObject:function(object) {
        ...
        if(this.getRight() < object.getLeft() || this.getBottom() < object.getTop() || this.getLeft() > object.getRight() || this.getTop() > object.getBottom()) return false;
    ...
    collideObjectCenter:function(object) {
        ...
        if( center_x < this.getLeft() || center_x > this.getRight() || center_y < this.getTop() || center_y > this.getBottom() ) return false;
...
Game.TileSet = function(columns, tile_size) {
    ...
    this.frames = [new f(115,  97, 13, 16, 0, -4), // idle-left
        new f( 50,  97, 13, 16, 0, -4), // jump-left
        new f(102,  96, 13, 16, 0, -4), new f(89, 96, 13, 16, 0, -4), new f(76, 96, 13, 14, 0, -4), new f(63, 96, 13, 16, 0, -4), // walk-left
        ...
        new f( 81, 112, 11, 16), new f( 81, 112, 11, 16), // carrot
...
Game.World = function(friction = 0.85, gravity = 2){
    ...
    this.carrot_count = 0;
    this.doors = [];
    this.door = undefined; //jeżeli gracz przekroczy drzwi gra ustawi wartosc
...
Game.World.prototype = {
    ...
    constructor: Game.World,
                ...
                setup:function(zone) {
                    ...
                    if(this.door) {
                        ...
                        if(this.door.destination_x != -1) {
                            ...
                            this.player.setOldCenterX(this.door.destination_x); //reset
                        }

                        if(this.door.destination_y != -1) {

                            this.player.setCenterY(this.door.destination_y);
                            this.player.setOldCenterY(this.door.destination_y); //reset
                        }
        ...
        update:function() {
            ...
            // this.player.velocity_x *= this.friction; // friction - tarcie

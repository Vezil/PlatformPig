window.addEventListener("load",function(event){
    ...
    var render = function() {
        ...
        for(let index = game.world.carrots.length -1; index > -1; --index){
            ...
            display.drawObject(assets_manager.tile_set_image, frame.x, frame.y, carrot.x + Math.floor(carrot.width * 0.5 - frame.width * 0.5) + frame.offset_x , carrot.y + frame.offset_y, frame.width, frame.height);
        ...
        display.drawObject(assets_manager.tile_set_image, frame.x, frame.y, game.world.player.x + Math.floor( game.world.player.width * 0.5 - frame.width * 0.5) + frame.offset_x,
    ...
    var update = function(){
        ...
        if(controller.up.active) { game.world.player.jump(); controller.up.active = false; /*zeby nie mozna bylo skakac podczas skoku */ }
